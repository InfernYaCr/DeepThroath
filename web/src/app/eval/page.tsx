...
import { Activity, LayoutGrid, AlertTriangle, ShieldCheck, FileText, Loader2, ArrowRight, Download, Rocket, Printer } from "lucide-react";
    ...
    <div className="w-full space-y-10">
        ...
        <Tabs defaultValue="overview" className="space-y-8">
            <TabsList className="bg-[#f2f3f5] shadow-inner border border-[#e5e7eb] p-2 rounded-lg gap-2 h-auto">
               ...
               <TabsTrigger value="logs" className="px-6 py-3 text-base rounded-md data-[state=active]:bg-white data-[state=active]:text-[#222222] data-[state=active]:shadow-[rgba(0,0,0,0.08)_0px_2px_4px] data-[state=active]:shadow-lg text-[#45515e] hover:text-[#222222] font-medium drop-shadow-sm transition-all">Детали и логи</TabsTrigger>
            </TabsList>
              ...
              <div className="bg-[#f2f3f5] rounded-[24px] border border-[#e5e7eb] p-8 shadow-[rgba(0,0,0,0.08)_0px_4px_6px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <Card className="bg-white border-[#bfdbfe]">
                    ...
                    <CardContent className="space-y-3">
                      <p className="text-[#45515e] text-sm leading-relaxed">
                        <strong>Что измеряет:</strong> Насколько ответ модели релевантен заданному вопросу.
                      </p>
                      <p className="text-[#45515e] text-sm leading-relaxed">
                        <strong>Как работает:</strong> Анализирует соответствие ответа теме и контексту вопроса, игнорируя лишнюю информацию.
                      </p>
                      <p className="text-[#45515e] text-sm leading-relaxed">
                        <strong>Хороший результат:</strong> {">"} 80% — ответ точно отвечает на вопрос без отклонений.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-white border-[#fbcfe8]">
                    ...
                    <CardContent className="space-y-3">
                      <p className="text-[#45515e] text-sm leading-relaxed">
                        <strong>Что измеряет:</strong> Обоснованность ответа предоставленным контекстом (RAG).
                      </p>
                      <p className="text-[#45515e] text-sm leading-relaxed">
                        <strong>Как работает:</strong> Проверяет, что все утверждения в ответе подтверждаются документами из базы знаний.
                      </p>
                      <p className="text-[#45515e] text-sm leading-relaxed">
                        <strong>Хороший результат:</strong> {">"} 90% — нет галлюцинаций, ответ основан на фактах.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-white border-[#a5f3fc]">
                    ...
                    <CardContent className="space-y-3">
                      <p className="text-[#45515e] text-sm leading-relaxed">
                        <strong>Что измеряет:</strong> Точность подобранных чанков из базы знаний.
                      </p>
                      <p className="text-[#45515e] text-sm leading-relaxed">
                        <strong>Как работает:</strong> Оценивает, насколько релевантные документы находятся в топе результатов поиска.
                      </p>
                      <p className="text-[#45515e] text-sm leading-relaxed">
                        <strong>Хороший результат:</strong> {">"} 70% — система retrieval работает эффективно.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-white border-[#ddd6fe]">
                    ...
                    <CardContent className="space-y-3">
                      <p className="text-[#45515e] text-sm leading-relaxed">
                        <strong>Что измеряет:</strong> Полнота охвата ожидаемого ответа найденным контекстом.
                      </p>
                      <p className="text-[#45515e] text-sm leading-relaxed">
                        <strong>Как работает:</strong> Проверяет, что все необходимые факты для ответа присутствуют в извлеченных документах.
                      </p>
                      <p className="text-[#45515e] text-sm leading-relaxed">
                        <strong>Хороший результат:</strong> {">"} 75% — ничего важного не упущено при поиске.
                      </p>
                    </CardContent>
                  </Card>
                </div>
